!(function (t, e) {
    ...
    Object.defineProperty(m, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.24" }), Object.defineProperty(m, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: {} });
    class g extends m {
        constructor(t = {}) {
    ...
    class k extends g {
        ...
        updateControls() {
            ...
            let d = { toggleMax: r - h < 0.5 * (c - h) ? c : h, toggleCover: r - h < 0.5 * (l - h) ? l : h, toggleZoom: r - h < 0.5 * (o - h) ? o : h }[t.option("click") || ""] || h,
                ...
                m = p && f;
            if (
                (f && (e(r) < e(h) && !this.panOnlyZoomed && (m = !0), (e(s.width, 1) > e(s.fitWidth, 1) || e(s.height, 1) > e(s.fitHeight, 1)) && (m = !0)),
        ...
        applyChange({
            ...
            (y = y.translate(-o, -a).translate(-f, -m).multiply(g)), s && (y = y.rotate(s)), l && (y = y.scale(-1, 1)), c && (y = y.scale(1, -1));
            for (const t of v) "e" !== t && "f" !== t && (y[t] > this.minScale + 1e-5 || y[t] < this.minScale - 1e-5) ? (this.target[t] = y[t]) : (this.target[t] = e(y[t], T));
            (this.targetScale < this.scale || Math.abs(n - 1) > 0.1 || this.panMode === O || !1 === d) && !h && this.clampTargetBounds(), u === b.Init ? this.animate() : this.isResting || ((this.state = b.Panning), this.requestTick());
        }
        stop(t = !1) {
    ...
    class U extends g {
        ...
        initLayout() {
            ...
            i || ((i = document.createElement("div")), P(i, e.viewport), i.append(...F(t, `.${e.slide}`)), t.prepend(i));
        ...
        createPages() {
            ...
            let s = 0,
                o = 0,
                a = 0;
            for (const e of this.slides) (!t.length || o + e.dim - i > 0.05 || a === n) && (t.push(B()), (s = t.length - 1), (o = 0), (a = 0)), t[s].slides.push(e), (o += e.dim + e.gap), a++;
            return t;
        }
        processPages() {
            const t = this.pages,
            ...
            if (
                ...
                t.forEach((t, s) => {
                    o && !this.isInfinite && i > n && ((t.pos = Math.max(t.pos, 0)), (t.pos = Math.min(t.pos, i - n))), (t.pos = e(t.pos, 1e3)), (t.dim = e(t.dim, 1e3)), Math.abs(t.pos) <= 0.1 && (t.pos = 0);
                }),
                this.isInfinite)
            )
                return t;
        ...
        getSlideMetrics(t) {
            ...
            return (
                "content-box" === c.boxSizing && (this.isHorizontal ? ((o += parseFloat(c.paddingLeft) || 0), (o += parseFloat(c.paddingRight) || 0)) : ((o += parseFloat(c.paddingTop) || 0), (o += parseFloat(c.paddingBottom) || 0))),
        ...
        slideTo(t = 0, { friction: e = this.option("friction"), transition: i = this.option("transition") } = {}) {
            ...
            (d *= h), Math.abs(l.target[s] - d) < 0.1 || (l.panTo({ x: o ? d : 0, y: o ? 0 : d, friction: e }), this.onChange(n));
        }
        slideToClosest(t) {
            if (this.panzoom) {
    ...
    Object.defineProperty(U, "Panzoom", { enumerable: !0, configurable: !0, writable: !0, value: k }),
        Object.defineProperty(U, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: D }),
    ...
    class ot extends N {
        ...
        static startFromUrl() {
            if (((ot.hasSilentClose = !1), Qt.getInstance() || !1 === Qt.defaults.Hash)) return;
            const { hash: t, slug: e, index: i } = ot.parseURL();
            if (!e) return;
            let n = document.querySelector(`[data-slug="${t}"]`);
            if ((n && n.dispatchEvent(new CustomEvent("click", { bubbles: !0, cancelable: !0 })), Qt.getInstance())) return;
    ...
    class bt extends N {
        ...
        onClearContent(t, e) {
            ...
            if ("inline" === e.type && n && s)
                n.classList.remove("fancybox__content"), "none" !== n.style.display && (n.style.display = "none"), s.parentNode && s.parentNode.insertBefore(n, s), s.remove(), (e.contentEl = void 0), (e.placeholderEl = void 0);
        ...
        onUnselectSlide(t, e, i) {
            ...
            let o;
            i.type === ut ? (o = { method: "pause", value: "true" }) : i.type === dt && (o = { event: "command", func: "pauseVideo" }),
            ...
            const i = () => {
                if (t.iframeEl && t.iframeEl.contentWindow) {
                    ...
                    if ("true" === t.iframeEl.dataset.ready)
                        return (e = t.type === dt ? { event: "command", func: "playVideo" } : { method: "play", value: "true" }), e && t.iframeEl.contentWindow.postMessage(JSON.stringify(e), "*"), void (t.poller = void 0);
                    t.type === dt && ((e = { event: "listening", id: t.iframeEl.getAttribute("id") }), t.iframeEl.contentWindow.postMessage(JSON.stringify(e), "*"));
                }
        ...
        processType(t) {
            ...
            if ((n = e.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i))) {
                ...
                (t.videoId = c), (t.src = `https://${r}/embed/${c}?${l}`), (t.thumbSrc = t.thumbSrc || `https://i.ytimg.com/vi/${c}/mqdefault.jpg`), (i = dt);
            } else if ((n = e.match(/^.+vimeo.com\/(?:\/)?([\d]+)((\/|\?h=)([a-z0-9]+))?(.*)?/))) {
                const s = ft(e, this.optionFor(t, ut)),
                    o = encodeURIComponent(n[1]),
                    a = n[4] || "";
                (t.videoId = o), (t.src = `https://player.vimeo.com/video/${o}?${a ? `h=${a}${s ? "&" : ""}` : ""}${s}`), (i = ut);
            }
            if (!i && t.triggerEl) {
            ...
            i ||
                ("string" == typeof e &&
                    ("#" === e.charAt(0)
                        ...
                        ? ((i = pt), (t.videoFormat = t.videoFormat || "video/" + ("ogv" === n[1] ? "ogg" : n[1])))
                        ...
                        : (n = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) &&
                          ((t.src = `https://maps.google.${n[1]}/maps?q=${n[2].replace("query=", "q=").replace("api=1", "")}&output=embed`), (i = ht)))),
        ...
        setAspectRatio(t) {
            ...
            (e.style.aspectRatio = i + ""),
                i < a / r ? ((s = "auto" === s ? r : Math.min(r, s)), (e.style.width = "auto"), (e.style.height = `${s}px`)) : ((n = "auto" === n ? a : Math.min(a, n)), (e.style.width = `${n}px`), (e.style.height = "auto"));
        }
        attach() {
            const t = this,
                e = t.instance;
    ...
    Object.defineProperty(bt, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: mt });
    const vt = "play",
        yt = "pause",
        wt = "ready";
    class xt extends N {
        constructor() {
            super(...arguments),
                Object.defineProperty(this, "state", { enumerable: !0, configurable: !0, writable: !0, value: wt }),
    ...
    Object.defineProperty(xt, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: { autoStart: !0, pauseOnHover: !0, progressParentEl: null, showProgress: !0, timeout: 3e3 } });
    class Et extends N {
        constructor() {
    ...
    let Ct = class extends N {
        constructor() {
            super(...arguments),
                ...
                Object.defineProperty(this, "state", { enumerable: !0, configurable: !0, writable: !0, value: Pt.Init });
        }
        formatThumb(t, e) {
        ...
        build() {
            ...
            n ? n.appendChild(i) : t.after(i), (this.container = i), P(t, this.cn("hasThumbs"));
            const s = document.createElement("div");
            P(s, this.cn("track")), i.appendChild(s), (this.track = s), "classic" === e ? this.buildClassic() : this.buildModern(), (this.state = Pt.Ready);
        }
        cleanup() {
    ...
    Object.defineProperty(Ct, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: St });
    const Mt = Object.assign(Object.assign({}, St), { key: "t", showOnStart: !0, parentEl: null }),
        Tt = "is-masked",
        Ot = "aria-hidden";
    class At extends N {
        constructor() {
        ...
        toggle() {
            const t = this.ref;
            if (t && !t.isDisabled()) return t.state === Pt.Hidden ? ((t.state = Pt.Init), void t.build()) : void (this.hidden ? this.show() : this.hide());
        }
        show() {
            const t = this.ref;
            if (!t || t.isDisabled()) return;
            const e = t.container;
            e && (this.refresh(), e.offsetHeight, e.removeAttribute(Ot), e.classList.remove(Tt), (this.hidden = !1));
        }
        hide() {
            const t = this.ref,
                e = t && t.container;
            e && (this.refresh(), e.offsetHeight, e.classList.add(Tt), e.setAttribute(Ot, "true")), (this.hidden = !0);
        }
        refresh() {
            const t = this.ref;
            if (!t || !t.state) return;
    ...
    Object.defineProperty(At, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Mt });
    const zt = {
    ...
    class It extends N {
        ...
        onReady(t) {
            ...
            if ((o && (r = this.createContainer()), r)) {
                ...
                !0 === n && P(r, "is-absolute"), (this.state = Lt.Ready), this.onRefresh();
    ...
    Object.defineProperty(It, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: Rt });
    const Ft = { Hash: ot, Html: bt, Images: rt, Slideshow: Et, Thumbs: At, Toolbar: It },
        Dt = "with-fancybox",
        jt = "hide-scrollbar",
    ...
    class Qt extends g {
            ...
            (this.state = it.Init),
                ...
                !0 === this.option("hideScrollbar") &&
                    (() => {
                        ...
                        document.documentElement.style.setProperty(Ht, `${e}px`), n && t.style.setProperty(Bt, `${n}px`), t.classList.add(jt);
                    })(),
                this.initLayout(),
                this.scale();
            const t = () => {
        ...
        initCarousel(t) {
            ...
            s.on("*", (t, e, ...i) => {
                ...
                s.on(["refresh", "change"], (t) => {
                    ...
                    if (!t.isInfinite) {
                        for (const i of e.querySelectorAll("[data-fancybox-next]")) t.page < t.pages.length - 1 ? (i.removeAttribute($t), i.removeAttribute(Xt)) : (i.setAttribute($t, ""), i.setAttribute(Xt, "-1"));
                        for (const i of e.querySelectorAll("[data-fancybox-prev]")) t.page > 0 ? (i.removeAttribute($t), i.removeAttribute(Xt)) : (i.setAttribute($t, ""), i.setAttribute(Xt, "-1"));
                    }
                    ...
                    for (const t of e.querySelectorAll("[data-fancybox-download]")) {
                        ...
                        n
                            ? (t.removeAttribute($t), t.removeAttribute(Xt), t.setAttribute(qt, n), t.setAttribute(Yt, e || n), t.setAttribute("target", "_blank"))
                            : (t.setAttribute($t, ""), t.setAttribute(Xt, "-1"), t.removeAttribute(qt), t.removeAttribute(Yt));
                    }
                }),
        ...
        focus(t) {
            ...
            let h = null;
            t ? (!n || l.indexOf(n) < 0) && ((h = c || s), l.length && (i === Gt ? (h = l[0]) : (this.lastFocus !== s && i !== Ut) || (h = l[l.length - 1]))) : (h = o && "image" === o.type ? s : c || s),
                h && tt(h),
        ...
        proceedClose(t, e) {
            ...
            if ((r && (G(r) ? tt(r) : r.focus()), s && (P(s, "is-closing"), s.setAttribute("aria-hidden", "true"), this.option("animated") && P(s, Nt), (s.style.pointerEvents = "none")), o)) {
            ...
            i
                ...
                : (Ut && (Ut.remove(), (Ut = null)),
                  ...
                  (() => {
                      ...
                      const t = document,
                          e = t.body;
                      e.classList.remove(jt), e.style.setProperty(Bt, ""), t.documentElement.style.setProperty(Ht, "");
                  })(),
                  this.emit("destroy"));
        }
        static bind(t, e, i) {
            ...
            a.set(s, o), Qt.openers.set(n, a), 1 === a.size && n.addEventListener("click", Qt.fromEvent);
        }
        static unbind(t, e) {
            let i,
                n = "";
            ...
            s && n && s.delete(n), (n && s) || (Qt.openers.delete(i), i.removeEventListener("click", Qt.fromEvent));
        }
        static destroy() {
            let t;
            for (; (t = Qt.getInstance()); ) t.destroy();
            for (const t of Qt.openers.keys()) t.removeEventListener("click", Qt.fromEvent);
            Qt.openers = new Map();
        }
        static fromEvent(t) {
            if (t.defaultPrevented) return;
            ...
            return u && u.options.triggerEl && r.indexOf(u.options.triggerEl) > -1 ? void 0 : (e && (l.startIndex = r.indexOf(e)), Qt.fromNodes(r, l));
        }
        ...
        static fromNodes(t, e) {
            ...
            for (const n of t) {
                ...
                a && i.length === e.startIndex && (o = a instanceof HTMLImageElement ? a : a.querySelector("img:not([aria-hidden])")),
                    ...
                    o && ((r = o.currentSrc || o[Vt] || void 0), !r && o.dataset && (r = o.dataset.lazySrc || o.dataset[Vt] || void 0));
    ...
    Object.defineProperty(Qt, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.24" }),
        Object.defineProperty(Qt, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: et }),
        Object.defineProperty(Qt, "Plugins", { enumerable: !0, configurable: !0, writable: !0, value: Ft }),
        Object.defineProperty(Qt, "openers", { enumerable: !0, configurable: !0, writable: !0, value: new Map() }),
        (t.Carousel = U),
        (t.Fancybox = Qt),
        (t.Panzoom = k);
});
