 ...
 * @access public
 */
class GL_Customizer_Tabs_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'tabs-control-script', get_template_directory_uri() . '/inc/customizer/customizer-controls/tabs/script.js', array( 'jquery' ), CONSTRUCTIONN_PRO_VERSION, true );
		wp_enqueue_style( 'tabs-control-style', get_template_directory_uri() . '/inc/customizer/customizer-controls/tabs/style.css', null, CONSTRUCTIONN_PRO_VERSION );
	}
	...
	public function partials_helper_script_enqueue() {
		wp_enqueue_script( 'tabs-addon-script', get_template_directory_uri() . '/inc/customizer/customizer-controls/tabs/customizer-addon-script.js', array( 'jquery' ), CONSTRUCTIONN_PRO_VERSION, true );
	}
	 ...
	 * @return bool
	 */
	final protected function tab_has_controls( $controls_array ) {
		$i = 0;
	 ...
	 * @return bool
	 */
	final protected function more_than_one_valid_tab() {
		$i = 0;
