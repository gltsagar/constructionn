...
if ( ! function_exists( 'constructionn_pro_customize_register_abtpg_team' ) ) :
	/**
	 * Aboutpage Team
	 *
	 ...
	 * @return void
	 */
	function constructionn_pro_customize_register_abtpg_team( $wp_customize ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'abtpg_team_headings', __( 'Our working steps', 'constructionn-pro' ) ) );
				},
			)
		);
...
add_action( 'customize_register', 'constructionn_pro_customize_register_abtpg_team' );
