...
if ( ! function_exists( 'constructionn_pro_customize_register_projectpg_project' ) ) :
	/**
	 * Projectpage Project
	 *
	 ...
	 * @return void
	 */
	function constructionn_pro_customize_register_projectpg_project( $wp_customize ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'projpg_project_headings', __( 'Our latest projects', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'projpg_project_descs', __( 'Identifying the ideal legal strategy for you and your company. Reduce the price of your legal fees.', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'projpg_project_btn_txt', __( 'View All Projects', 'constructionn-pro' ) ) );
				},
			)
		);
...
add_action( 'customize_register', 'constructionn_pro_customize_register_projectpg_project' );
