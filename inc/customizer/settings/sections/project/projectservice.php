...
if ( ! function_exists( 'constructionn_pro_customize_register_projectpg_service' ) ) :
	/**
	 * Projectpage Service
	 *
	 ...
	 * @return void
	 */
	function constructionn_pro_customize_register_projectpg_service( $wp_customize ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'projpg_service_headings', __( 'Have any projects ?', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'projpg_btn_txt', __( 'View More', 'constructionn-pro' ) ) );
				},
			)
		);
...
add_action( 'customize_register', 'constructionn_pro_customize_register_projectpg_service' );
