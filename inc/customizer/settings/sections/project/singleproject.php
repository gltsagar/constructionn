...
if ( ! function_exists( 'constructionn_pro_customize_register_single_latestproject' ) ) :
	/**
	 ...
	 * @return void
	 */
	function constructionn_pro_customize_register_single_latestproject( $wp_customize ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'project_single_latestproj_headings', __( 'Our latest projects', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'project_single_latestproj_descs', __( 'Identifying the ideal legal strategy for you and your company. Reduce the price of your legal fees.', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'project_single_project_btn_txt', __( 'View All Projects', 'constructionn-pro' ) ) );
				},
			)
		);
...
add_action( 'customize_register', 'constructionn_pro_customize_register_single_latestproject' );
