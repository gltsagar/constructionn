...
if ( ! function_exists( 'constructionn_pro_customize_register_teampg_cta' ) ) :
	/**
	 * Teampage CTA
	 *
	 ...
	 * @return void
	 */
	function constructionn_pro_customize_register_teampg_cta( $wp_customize ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'teampg_cta_heading', __( 'Have any projects ?', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'teampg_cta_descs', __( 'Do not hesitate to contact us and get the best outcomes from our professionals.', 'constructionn-pro' ) ) );
				},
			)
		);
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => function () {
						return esc_html( get_theme_mod( 'teampg_contact_number', __( '+1-202-555-0133', 'constructionn-pro' ) ) );
				},
			)
		);
...
add_action( 'customize_register', 'constructionn_pro_customize_register_teampg_cta' );
