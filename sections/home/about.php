 ...
 */
$about_subheading      = get_theme_mod( 'about_subheading', __( 'Who we are', 'constructionn' ) );
$about_headings        = get_theme_mod( 'about_headings', __( 'Start your journey with professionals', 'constructionn' ) );
$about_descriptions    = get_theme_mod( 'about_descriptions', __( 'We are a long-established, independent building services and home improvements company. We have a wealth of experience working as main building contractors on all kinds of projects, big and small, from home maintenance.', 'constructionn' ) );
$notice_headings       = get_theme_mod( 'notice_headings', __( 'Get close to more than 150 expert professionals', 'constructionn' ) );
$notice_descriptions   = get_theme_mod( 'notice_descriptions', __( 'Receive the greatest results from us.', 'constructionn' ) );
$about_btn_txt         = get_theme_mod( 'about_btn_txt', __( 'Know More', 'constructionn' ) );
...
constructionn_get_about_section(
