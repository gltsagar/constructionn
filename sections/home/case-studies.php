 ...
 */
$casestd_heading        = get_theme_mod( 'front_casestudies_heading', __( 'Case studies define our success.', 'constructionn' ) );
$front_casestd_repeater = get_theme_mod( 'front_casestudies_repeater', array() );
$cs_btn_txt             = get_theme_mod( 'cs_btn_text', esc_html__( 'Explore More', 'constructionn' ) );

constructionn_case_study(
