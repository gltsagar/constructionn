<?php
/**
 * Team Template Counter Section
 *
 * @package constructionn-pro
 */
$counter_headings              = get_theme_mod( 'teampg_counter_headings', __( 'Our goal is to make the design simple and useful.', 'constructionn-pro' ) );
